  ...
  return (
    ...
    <header className='flex items-center md:gap-10 bg-[#162121] justify-around p-3 fixed w-full'>
      ...
      <nav className='hidden text-white md:flex space-x-4 justify-center md:gap-10'>
        <Link to={"/about"} className="hover:text-foreground hover:scale-110 transition-all">About</Link>
        <Link to={"/projects"} className="hover:text-foreground hover:scale-110 transition-all">Projects</Link>
        <Link to={"/contact"} className="hover:text-foreground hover:scale-110 transition-all">Contacts</Link>
      </nav>
      ...
      <nav className={`${nav
        ...
        <Link to={"/contact"} onClick={toggleNav}>Contacts</Link>
      </nav>
    </header>
