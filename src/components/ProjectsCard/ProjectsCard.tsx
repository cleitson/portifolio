...
function ProjectsCard({ data }: CardProps) {
  return data.map((projeto) => (
    <div className="flex flex-col justify-around flex-wrap md:w-[21rem] gap-5 bg-[#0D1E20] p-3 rounded-xl" key={projeto.id}>
      ...
      <div className="flex gap-5 justify-end">
        { projeto.github && <a href={projeto.github} target="_blank"><GrGithub size={35} /></a>}
